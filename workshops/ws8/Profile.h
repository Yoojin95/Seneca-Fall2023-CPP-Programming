	...
	struct Profile {
		...
		void validateAddress() const
		{
			if (m_address.number < 0 ||
				...
				!std::isalpha(m_address.postal_code[0]) || !std::isdigit(m_address.postal_code[1]) ||
				!std::isalpha(m_address.postal_code[2]) || !std::isspace(m_address.postal_code[3]) ||
				!std::isdigit(m_address.postal_code[4]) || !std::isalpha(m_address.postal_code[5]) ||
